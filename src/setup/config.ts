...
function readAgentRuntimeEnvironment(env: NodeJS.ProcessEnv): Readonly<Record<string, string>> | undefined {
  ...
  for (const key of [
    ...
    "CARVIS_DEEPSEEK_API_KEY",
    "CARVIS_DEEPSEEK_OPENAI_BASE_URL",
    "CARVIS_DEEPSEEK_RESEARCHER_MODEL",
    "CARVIS_DEEPSEEK_API_TIMEOUT_MS",
    "CARVIS_SCRAPLING_PYTHON",
    "CARVIS_SCRAPLING_SEARCH",
    "CARVIS_SCRAPLING_LD_LIBRARY_PATH",
    "CARVIS_SCRAPLING_TIMEOUT_MS",
    "CARVIS_SCRAPLING_MAX_RESULTS",
